...
void _MIPS32 lib_wait(int period){
	int i;
...
int _MIPS32 _call_library(int a0,int a1,int a2,enum libs a3);
...
int _MIPS32 _call_library(int a0,int a1,int v0,enum libs a3){
